...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	while ( ( no_of_sequences = copy_sequences_to_cuda_memory(ks, global_sequences_index, main_sequences_index, global_sequences, main_sequences, &read_size, max_sequence_length, opt->mid, buffer) ) > 0 )
	{
		...
		if (split_kernel) {
			hipLaunchKernelGGL((cuda_split_inexact_match_caller), dim3(dimGrid), dim3(dimBlock), 0, 0, no_of_sequences, max_sequence_length, global_alignment_store_device, 0);
		} else {
			hipLaunchKernelGGL((cuda_inexact_match_caller), dim3(dimGrid), dim3(dimBlock), 0, 0, no_of_sequences, max_sequence_length, global_alignment_store_device, 0);
		}
