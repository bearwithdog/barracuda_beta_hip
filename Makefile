...
ifeq ($(dbg),1)
	...
	BINSUBDIR   := release
	LIBSUFFIX   :=
	#NVCCFLAGS   += --compiler-options -fno-strict-aliasing --compiler-options -fno-inline   (chang 1)
        NVCCFLAGS   += -fno-strict-aliasing -fno-inline  	
...
#LIB += -lcudart -lcuda
#LIB += -L/opt/rocm/hip/lib/
LIB += -L/public/home/zhangyz/HIP-master/build/
LIB += -lamdhip64
#LIB += -lhiprtc -lhip_hcc
